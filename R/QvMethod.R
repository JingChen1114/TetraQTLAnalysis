QvMethod <-
function(n,mloci,ftype,mtype,alpha,rec,o,trait){
  mxind=500
  mxloci=400
  ...
  cat("Coeffecint of double reduction at the putative QTL:\n")
  print(out$alpha_max)
  cat("G1:\n")
  print(out$u_max[1])
  cat("G2:\n")
  ...
  print(out$sigma_max)
  return(list(out$fqtl_max,out$mqtl_max,out$BIC_min,out$gDistance_max,out$alpha_max,out$u_max,out$sigma_max))
}
